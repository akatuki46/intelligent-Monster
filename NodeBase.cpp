...
{
	//実行ノードを見つけるまで繰り返し実行（Actionがあるまで）

	std::vector<NodeBase*> list;
	NodeBase *result = NULL;

	// 子ノードで実行可能なノードを探す（アクティブノードか非アクティブノードかの判定）
